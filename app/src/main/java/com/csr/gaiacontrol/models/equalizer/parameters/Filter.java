...
/**
 * This enumeration encapsulates all possible values for the band filters for the equaliser parameter feature.
 */
public enum Filter {
    /**
    ...
    /**
     * To get the parameters ranges corresponding to the given filter.
     *
     * @param filter
     *              the filter which we want the characteristics.
     * @param frequency
     *              the frequency parameter to define its range.
     * @param gain
     *              the gain parameter to define its range.
     * @param quality
     *              the quality parameter to define ots range.
     */
